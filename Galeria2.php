...
<html lang="en">
    ...
    <body>
		<div class="container">
			...
			<div class="content">
				<h1><?php echo $album->Nombre ?><span><?php echo $album->Descripcion ?></span></h1>
...
?>
									<li><a href="#"><img src="<?php echo "galeria/".$album->idAlbum."/thumbs/".$foto->url; ?>" data-large="<?php echo "galeria/".$album->idAlbum."/".$foto->url; ?>" alt="image01" data-description="<?php echo $foto->Titulo; ?>" /></a></li>
<?php
	}
?>
								</ul>
