...
if($_GET["opc"]=="0"){
	$consulta="SELECT * FROM ceu WHERE CEU LIKE'%".$_GET["usuario"]."%' OR Nombre LIKE'%".$_GET["usuario"]."%' OR Carne LIKE'%".$_GET["usuario"]."%' OR DUI LIKE'%".$_GET["usuario"]."%'".$condicion." ORDER BY CEU ASC";
//	echo $consulta;
}
//echo $consulta;
$tamanopag=15;
...
echo $total." cuentas coinciden con su busqueda<br>";
